...
public class NMQMClassTransformer implements IClassTransformer {
    ...
    private byte[] patchContainer(byte[] basicClass) {		
	    ...
	    containerClassName = NMQMCorePlugin.isObfuscated() ? "aau" : "net/minecraft/inventory/Container",
	    itemStackClassName = NMQMCorePlugin.isObfuscated() ? "adq" : "net/minecraft/item/ItemStack",
	    clickTypeClassName = NMQMCorePlugin.isObfuscated() ? "aaz" : "net/minecraft/inventory/ClickType",
	    entityPlayerClassName = NMQMCorePlugin.isObfuscated() ? "zj" : "net/minecraft/entity/player/EntityPlayer"; 		    
	...
	private byte[] patchGuiContainer(byte[] basicClass) {        
        ...
        classReader.accept(classNode, 0);
	 	...
	 	clickTypeClassName = NMQMCorePlugin.isObfuscated() ? "aaz" : "net/minecraft/inventory/ClickType",
	 	slotClassName = NMQMCorePlugin.isObfuscated() ? "abt" : "net/minecraft/inventory/Slot";  	 	
        boolean isSuccessful = false;       
        int aloadCount = 0;       
        AbstractInsnNode currentInsn;
	...
	private byte[] patchCLickWindowPacket(byte[] basicClass) {		
	    ...
	    clickTypeClassName = NMQMCorePlugin.isObfuscated() ? "aaz" : "net/minecraft/inventory/ClickType",
	    iNetHandlerPlayServerClassName = NMQMCorePlugin.isObfuscated() ? "ih" : "net/minecraft/network/play/INetHandlerPlayServer",
	    cPacketClickWindowClassName = NMQMCorePlugin.isObfuscated() ? "ip" : "net/minecraft/network/play/client/CPacketClickWindow";	 		    
        boolean isSuccessful = false;        
        AbstractInsnNode currentInsn;
